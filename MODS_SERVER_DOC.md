...
*   **Важливо (Виправлення URL):** Оскільки WebSocket в API зареєстрований без префікса `/api/v1`, при формуванні `wsUrl` у класі `SkyBlockMod` потрібно обов'язково видаляти цей префікс з базової адреси, інакше ви отримаєте помилку 404.
